...
describe('QueueStatus', () => {
  ...
  it('shows taking longer message when startTime is more than 1 minute ago', () => {
    ...
    expect(screen.getByText(/this is taking longer as expected/i)).toBeInTheDocument();
  });
  ...
  it('does not show taking longer message when startTime is less than 1 minute ago', () => {
    ...
    expect(screen.queryByText(/this is taking longer as expected/i)).not.toBeInTheDocument();
  });
